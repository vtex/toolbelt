...
import { abtester, formatDuration, installedABTester } from '../../../lib/test/ab'
...
const printResultsTable = (testInfo: ABTestStatusInterface) => {
  const {
    ABTestBeginning,
    WorkspaceA,
    WorkspaceB,
...
export const abTestStatus = async () => {
