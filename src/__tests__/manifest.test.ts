...
test.each([
  ['foo@', false], ['foo_bar', true], ['foo-bar', true], ['foo', true],
...
test.each([
  ['0.1', false], ['0.1.0_beta', false], ['0.1.0', true], ['0.1.0-beta', true],
...
test.each([
  ['x.1.0', false], ['0.1.x_beta', false], ['0.x', true], ['0.1.x', true], ['0.1.x-beta', true],
